...
const WORDS = [
  // طبيعة وبيئة
  'مجلس','نخلة','رمل','بحر','هلال','نجمة','قمر','شمس','موج','ريح',
  'غيم','مطر','برق','واد','جبل','هضبة','كهف','غابة','شلال','بركة',
  'خليج','جزيرة','مضيق','شعاب','قاع','نسيم','سحاب','ضباب','صخرة','لجة',
  'تل','حقل','بستان','حديقة','مزرعة','قناة','ساحل','شاطئ','رمال','واحة',
  'صحراء','فيافي','سهل','نهر','بحيرة','ينبوع','شجرة','غصن','جذر','تربة',

  // حيوانات
  'صقر','حصان','غزال','أسد','نمر','ذئب','ثعلب','أرنب','طاووس','نسر',
  'باز','حمام','بلبل','دولفين','حوت','نحل','فراشة','طائر','ناقة','جمل',
  'ضب','وعل','نعامة','تمساح','قنفذ','سلحفاة','عقاب','شاهين','هدهد','قطا',
  'حمار','ثور','عنز','خروف','ديك','دجاجة','بطة','أرنب','سمك','حمار وحشي',

  // أكل وشرب
  'قهوة','شاي','عسل','تمر','رمان','زيت','ملح','فلفل','بصل','ثوم',
  'ليمون','زنجبيل','كركم','سمسم','زبيب','تين','توت','مشمش','برتقال','جوز',
  'فستق','بندق','لوز','كاجو','حبهان','قرنفل','زعفران','هيل','قرفة','كمون',
  'برياني','مندي','كبسة','مجبوس','هريس','لقيمات','محمر','جريش','مراق','خبز',
  'حلوى','دبس','سمن','لبن','عصيدة','بليلة','فول','عيش','تشريب','باجلة',

  // عادات وتراث
  'دله','فنجان','مشب','عود','بخور','عطر','خنجر','درع','سيف','رمح',
  'طبل','دف','رباب','مزمار','رقصة','سامري','عرضة','فن','شعر','قصيدة',
  'مثل','حكمة','قصة','راوي','سهرة','مجلس','ديوانية','بيت شعر','خطبة','دعاء',
  'عباية','بشت','غترة','عقال','كندورة','مسبحة','سجادة','مسواك','كحل','حناء',

  // مكان وعمران
  'سوق','ميناء','قلعة','برج','مسجد','مئذنة','قبة','بوابة','صرح','نافورة',
  'بئر','خزان','جسر','نفق','طريق','ملعب','متحف','فندق','مطار','ميدان',
  'مطبخ','باب','نافذة','سقف','أرض','جدار','سلم','غرفة','حوش','سطح',
  'محلة','فريج','حارة','قرية','مدينة','صحن','مخزن','دكان','مستودع','مزرعة',

  // بحر وسفر
  'سفينة','فنار','شراع','صياد','مرسى','لبان','مرجان','لؤلؤة','عنبر','صدف',
  'قارب','مجداف','شبكة','قرصان','رحلة','سفر','منفى','وطن','غربة','عودة',
  'بوصلة','خريطة','ربان','مرساة','عاصفة','موجة','تيار','عمق','شعاب مرجانية','بحار',

  // ذهب ومعادن وجواهر
  'ذهب','فضة','نحاس','حديد','ماس','ياقوت','زمرد','عقيق','فيروز','كهرمان',

  // أخرى خليجية
  'قهوة','وليمة','ضيافة','كرم','شهامة','نخوة','حمد','ثقة','أمانة','وفاء',
  'غيرة','شوق','حنين','ذكرى','أمل','صبر','عزم','همة','شجاعة','حكمة',
];
